...
public class Sidecar2SampleKeys {
    ...
    public static final String FMCT_XLSX_VAL = "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet";
    ...
    public static final JsonNode FORMA_VAL = mapper.createObjectNode().put(EXAMPLE_FUN_ARG, FORMA_ANS);
}
