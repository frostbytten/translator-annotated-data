...
public class SheetGenerator {
    public static class SheetCheckFrame {
        ...
        public SheetCheckFrame(String name, Integer dataStartRow, Integer dataEndRow, String context, boolean valid) {
    ...
    public static class SheetCheckBuilder {
        ...
        public SheetCheck build() {
            return new SheetCheck(json, new SheetCheckFrame(name, dataStartRow, dataEndRow, context, valid));
        }
    }
}
