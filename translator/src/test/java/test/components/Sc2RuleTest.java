...
public class Sc2RuleTest {
    public static RuleCheck ruleMinimum = new RuleCheckBuilder(true)
                .withIcasa(SMI_VAL)
                .withColumnIndex(SMCI_VAL)
                .build();

    public static RuleCheck ruleFull = new RuleCheckBuilder(true)
                .withIcasa(SMI_VAL)
                .withColumnIndex(SMCI_VAL)
                .withUnit(SMU_VAL)
    ...
    public static RuleCheck ruleInvalidCI = new RuleCheckBuilder(false)
                .withIcasa(SMI_VAL)
                .withColumnIndex(SMCI_INVAL)
                .build();

    public static RuleCheck ruleInvalidCC = new RuleCheckBuilder(false)
                .withIcasa(SMI_VAL)
                .withColumnIndex(SMCI_VAL)
                .withCategory(SMC_INVAL)
                .build();

    public static RuleCheck ruleMissingIcasa = new RuleCheckBuilder(false)
                .withColumnIndex(SMCI_VAL)
                .build();
    
    public static RuleCheck ruleMissingCI = new RuleCheckBuilder(false)
                .withIcasa(SMI_VAL)
                .build();

    public static RuleCheck ruleValue = new RuleCheckBuilder(true)
        .withIcasa(SMI_VAL)
        .withValue(SMV_VAL)
        .build();

    public static RuleCheck ruleExplicitNullValue = new RuleCheckBuilder(false)
        .withIcasa(SMI_VAL)
        .withValue(null)
        .build();

    public static RuleCheck ruleValueWithColumnIndex = new RuleCheckBuilder(true)
        .withIcasa(SMI_VAL)
        .withColumnIndex(SMCI_VAL)
        .withValue(SMV_VAL)
        .build();
