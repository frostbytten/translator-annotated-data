...
public class Sc2FormulaTest {
    ...
    public static FormulaCheck formulaInvalidFunction = new FormulaCheckBuilder(false)
            .withFunction(FORMF_INVAL)
            .build();
    public static FormulaCheck formulaFunExample = new FormulaCheckBuilder(true)
            .withFunction(FORMF_VAL)
            .withFunctionArgs(FORMA_VAL)
            .build();
    public static FormulaCheck formulaFunExampleFail = new FormulaCheckBuilder(false)
            .withFunction(FORMF_VAL)
